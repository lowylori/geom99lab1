...
```
[https://YourDirectionsApiURLGoesHere](https://maps.googleapis.com/maps/api/directions/json?origin=Magic+Kingdom+Park&destination=Disney%27s+Animal+Kingdom+Lodge&key=AIzaSyCM-WWHYHIKY-do4kquMy9Z4wQaQx51AuE)
```
